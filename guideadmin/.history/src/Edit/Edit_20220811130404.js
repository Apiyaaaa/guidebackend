      ...
      <div className="panel">
        ...
        <div className="display-window">
          ...
          <div className="fillup-form">
            <TextField multiline label="输入标题" id="title"></TextField>
            <br />
            <TextField multiline label="输入简介" id="summary"></TextField>
            <TextField label="输入标签并且以“,”隔开" id="tags"></TextField>
          </div>
